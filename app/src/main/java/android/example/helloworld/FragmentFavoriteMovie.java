...
import android.example.helloworld.RealmHelper;

import java.util.ArrayList;
import java.util.List;

public class FragmentFavoriteMovie extends Fragment implements ListAdapter.onSelectData {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rvMovieFav.setAdapter(new ListAdapter(getActivity(), modelMovie, this));
